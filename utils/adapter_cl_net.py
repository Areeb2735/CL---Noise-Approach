...
class CNN_Adapter_Net_CIL_V2(IncrementalNet):
    def __init__(self, logger, backbone_type, pretrained, pretrain_path=None, layer_names:Iterable[str]=[], mode=None, task_id = 1):
        '''
    ...
    def apply_adapters(self, adapter_id: str) -> Callable:
        def hook(module, input):
            ...
            if len(getattr(self, adapter_id)) < self.task_id:
